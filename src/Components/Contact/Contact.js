...
const Contact = () => {
  ...
  const form = useRef();
  const [data,setData]= useState({name:"",email:"",telephone:"",message:""})
  const [error, setError] = useState(null);

  const handleChange=(e)=>{
    const name = e.target.name
    const value = e.target.value
    // console.log("Before setData:", data); // Log before updating state
    ...
    <>
      ...
      <div className='contact'>
          ...
          <div id="container">
            ...
            <form ref={form} onSubmit={handleSubmit} id="contact_form">
              <div className="name">
                <label htmlFor="name" />
                <input
                  type="text"
